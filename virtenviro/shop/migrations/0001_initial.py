    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(null=True, verbose_name='Description', blank=True)),
                ('slug', models.CharField(max_length=60, verbose_name='Slug')),
                ('image', models.ImageField(upload_to=b'H:/GITHUB/virtenviro\\..\\media\\img\\shop\\sellers', null=True, verbose_name='Image', blank=True)),
                ('address', models.CharField(max_length=255, null=True, verbose_name='Address', blank=True)),
                ...
                ('postal_zip', models.CharField(max_length=255, null=True, verbose_name='ZIP', blank=True)),
                ('site', models.URLField(null=True, verbose_name='Site', blank=True)),
                ('email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('phones', models.TextField(null=True, verbose_name='Phones', blank=True)),
                ('itn', models.CharField(max_length=255, null=True, verbose_name='Individual Taxpayer Number', blank=True)),
